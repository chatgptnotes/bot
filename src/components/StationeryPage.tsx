...
const STATIONERY_CATEGORIES = [
  ...
  { id: 'other', label: 'Notes & Handovers', icon: 'folder', examples: ['Patient Rights', 'Visitor Guidelines', 'Handover Format', 'Incident Reporting', 'Safety Rounds'] },
];
...
const DEFAULT_STATIONERY_ITEMS: StationeryItem[] = [
  ...
  },
  {
    ...
    category: 'other',
    description: 'Medical incident and near-miss reporting template',
    status: 'pending',
    userSuggestions: [],
    createdAt: '2026-02-03T10:00:00.000Z',
    updatedAt: '2026-02-03T10:00:00.000Z',
