...
const generateMockSearchData = (): SearchResult[] => [
  ...
  // Surveys
  {
    ...
    content: 'Staff satisfaction survey covers work environment, management support, career development, work-life balance, communication, resources, safety protocols, compensation, and NABH awareness. 15 questions targeting all hospital staff.',
    category: 'Staff Feedback',
    tags: ['staff', 'satisfaction', 'employee', 'feedback', 'nabh', 'work environment'],
    priority: 'high' as const,
    lastUpdated: '2024-02-03',
    url: '/surveys',
    matchedFields: [],
  ...
  // Cheat Sheets
  {
    ...
    subtitle: 'Access, Assessment & Continuity of Care',
    description: 'Quick reference sheet for AAC chapter standards and requirements',
    content: 'AAC chapter covers patient admission, assessment, care planning, continuity of care, and discharge planning. Key standards include admission criteria, assessment protocols, and care coordination.',
    chapter: 'AAC',
    category: 'Reference',
    tags: ['aac', 'admission', 'assessment', 'continuity', 'reference', 'standards'],
    priority: 'medium' as const,
    lastUpdated: '2024-02-01',
    url: '/cheat-sheets',
    matchedFields: [],
